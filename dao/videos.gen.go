...
func newVideo(db *gorm.DB, opts ...gen.DOOption) video {
	...
	_video.VideoID = field.NewUint(tableName, "video_id")
	_video.VideoURL = field.NewString(tableName, "video_url")
	_video.VideoCover = field.NewString(tableName, "video_cover")
...
func (v *video) updateTableName(table string) *video {
	...
	v.VideoCover = field.NewString(table, "video_cover")
...
func (v *video) fillFieldMap() {
	...
	v.fieldMap["video_cover"] = v.VideoCover
...
type IVideoDo interface {
	...
	Unscoped() IVideoDo
	Create(values ...*models.Video) error
	CreateInBatches(values []*models.Video, batchSize int) error
	Save(values ...*models.Video) error
	First() (*models.Video, error)
	Take() (*models.Video, error)
	Last() (*models.Video, error)
	Find() ([]*models.Video, error)
	FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*models.Video, err error)
	FindInBatches(result *[]*models.Video, batchSize int, fc func(tx gen.Dao, batch int) error) error
	Pluck(column field.Expr, dest interface{}) error
	Delete(...*models.Video) (info gen.ResultInfo, err error)
	...
	FirstOrInit() (*models.Video, error)
	FirstOrCreate() (*models.Video, error)
	FindByPage(offset int, limit int) (result []*models.Video, count int64, err error)
